function [q_el_s,q_el,uaQuat_s,faQuat_s] = mekf_knee_acc_s(ua,fa,freq,gyrNoise, conNoise, dofNoise, rUA,rFA,q1,q2)
...
for i = 2:n
    ...
    H(4,:) = [-[1 0 0]*J1*[1;0;0], [1 0 0]*J1*[1;0;0], 0, 0, -[0 0 1]*J2*[0;0;1], [0 1 0]*J2*[0;0;1]]; 
    % knee constraint (limits varus/valgus)
    %H(4,:) = [-[0 0 1]*J1*[0;1;0], [0 1 0]*J1*[0;1;0], 0, 0, -[0 0 1]*J2*[0;1;0], [0 1 0]*J2*[0;1;0]];
