...
imu_data_ml = np.load(os.path.join(results_path, "IMU_data_ml.npy"), allow_pickle=True)

# Load labels
labels_extendedLeg_100 = np.load(os.path.join(results_path, "labels_extendedLeg_IMU_100.npy"), allow_pickle=True)
labels_stiffMovement_100 = np.load(os.path.join(results_path, "labels_stiffMovement_IMU_100.npy"), allow_pickle=True)

#Load RING
ring_path = "../imt-main/examples/results"
ring_angles_kl = np.load(os.path.join(ring_path, "Angles_IMU_RING_Knee_Left.npy"), allow_pickle=True)
ring_angles_kr = np.load(os.path.join(ring_path, "Angles_IMU_RING_Knee_Right.npy"), allow_pickle=True)
seq_names = np.load(os.path.join(ring_path, "Sequences_names.npy"), allow_pickle=True)
...
X = np.vstack(X)
#X = np.concatenate((X, imu_data_ml))
