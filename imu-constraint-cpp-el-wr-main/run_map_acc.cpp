...
int main(int argc, char **argv)
{
    ...
    rUA2 << atof(argv[6]), atof(argv[7]), atof(argv[8]); 
    rFA << atof(argv[9]), atof(argv[10]), atof(argv[11]); 
    q1_imu << atof(argv[12]), atof(argv[13]), atof(argv[14]), atof(argv[15]); 
    q2_imu << atof(argv[16]), atof(argv[17]), atof(argv[18]), atof(argv[19]); 
    double tol = atof(argv[20]); 
    double lam = atof(argv[21]); 
    int max_iter = atoi(argv[22]); 
    ...
    ArrayXXd out = map_acc(gyro1, accel1, gyro2, accel2, freq, priNoise, gyrNoise, conNoise, rUA2, rFA, q1_imu, q2_imu, tol, lam, max_iter); 
