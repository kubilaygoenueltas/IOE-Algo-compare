function out=orientation_estimation_ahrs_mkmc_fun_debug(acc,gyro,fs,sigma_x) %(acc,gyro,mag,fs,sigma_x,sigma_y,MagSth)
...
for i=1:len
   ...
   %mdiffer=[0,0,0];
   %m=magVecGyroMeas;
   m=[0 0 0];              % Matrix H wird mit Nullen gefüllt dadurch
   % observer model
   k=dT;
